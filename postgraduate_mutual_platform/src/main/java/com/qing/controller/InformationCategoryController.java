...
public class InformationCategoryController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params, InformationCategoryEntity category, HttpServletRequest request){
        EntityWrapper<InformationCategoryEntity> ew = new EntityWrapper<InformationCategoryEntity>();
    ...
    public R info(@PathVariable("id") String id){
        InformationCategoryEntity category = categoryService.selectById(id);
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody InformationCategoryEntity category, HttpServletRequest request){
    ...
    public R update(@RequestBody InformationCategoryEntity category, HttpServletRequest request){
