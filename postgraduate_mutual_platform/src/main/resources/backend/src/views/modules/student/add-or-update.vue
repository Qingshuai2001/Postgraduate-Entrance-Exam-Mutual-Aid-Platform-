  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="24">
        <el-form-item class="upload" v-if="type!='info'" label="头像" prop="avatar">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业" prop="major">
          <el-input v-model="ruleForm.major"
              placeholder="专业" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业" prop="major">
              <el-input v-model="ruleForm.major"
...
<!--      </el-col>-->
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'"  label="余额" prop="money">
            <el-input v-model="ruleForm.money"
                      placeholder="余额" clearable ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="余额" prop="money">
              <el-input v-model="ruleForm.money"
