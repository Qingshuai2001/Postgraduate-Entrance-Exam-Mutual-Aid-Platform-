<template>
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgb(225,250,250);borderRadius:20px">
        <h1 class="h1" style="color:#b77635;fontSize:26px;">管理员注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="60px">
			...
			<el-form-item label="手机号" class="input">
			  <el-input v-model="ruleForm.phone" autocomplete="off" placeholder="手机号" type="text" />
			</el-form-item>
