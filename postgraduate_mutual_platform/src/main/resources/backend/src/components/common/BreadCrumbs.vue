...
<!--  backgroundColor:white;-->
  <el-breadcrumb class="app-breadcrumb" separator="⭐" style="height:50px;
 borderRadius:20px;padding:;boxShadow:;borderWidth:2px;borderStyle:;
